...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = ECC_ETC_ip3(params,period,inits)
    fluxvar   =params(1);
    t_max     =params(2);
    K_c       =params(3);
    K_h       =params(4);
    ...
    global initStates;
    initStates=inits;
   [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(period);
end
...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(period)
    % Create ALGEBRAIC of correct size
    global algebraicVariableCount;  algebraicVariableCount = getAlgebraicVariableCount();
    % Initialise constants and state variables
    [INIT_STATES, CONSTANTS] = initConsts(period);
...
function [STATES, CONSTANTS] = initConsts(period)
